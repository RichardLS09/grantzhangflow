...
def backward_check(f, *args, **kwargs):
    eps = 1e-5
    # print()
    # print("in",args[0].numpy().tobytes())
    out = f(*args, **kwargs)
    # print("out",out.numpy().tobytes())
    c = np.random.randn(*out.shape)
    # print("c",c.tobytes(), c.dtype,c)
    ...
    # print("backward_grad",backward_grad[0].numpy().tobytes())
    # print("numerical_grad", numerical_grad[0].tobytes(), numerical_grad[0].dtype,numerical_grad[0])
    error = sum(
